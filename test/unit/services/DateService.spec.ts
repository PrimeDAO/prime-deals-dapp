import { DateService, TimespanResolution } from "../../../src/services/DateService";
...
describe("DateService", () => {
  ...
  describe("#ticksToTimeSpanString", () => {
    ...
    const testData: TestData[] = [
      ...
      [TimespanResolution.largest2, [1, 0, 1, 1], "1 day, 0 hours"],
      [TimespanResolution.largest2, [1, 0, 1, 0], "1 day, 0 hours"],
      [TimespanResolution.largest2, [1, 0, 0, 1], "1 day, 0 hours"],
      [TimespanResolution.largest2, [1, 0, 0, 0], "1 day, 0 hours"],
      [TimespanResolution.largest2, [0, 1, 1, 1], "1 hour, 1 minute"],
      [TimespanResolution.largest2, [0, 1, 1, 0], "1 hour, 1 minute"],
      [TimespanResolution.largest2, [0, 1, 0, 1], "1 hour, 0 minutes"],
      [TimespanResolution.largest2, [0, 1, 0, 0], "1 hour, 0 minutes"],
