import { encryptForGnosis, verifyEIP1271Signature } from "../src/hash-validation"
...
describe("EIP-1271", () => {
  describe("encryption", () => {
    it("Should encrypt correctly", () => {
       ...
       */
      expect(result).toBe("0x5898e55e19df2268469c9ea3afd66469e79d08d94e014691b3d20c51f210a1b7")
    })
  })
