...
import { IEthereumService } from "../../../src/services/IEthereumService";
import { EthereumServiceTesting } from "../common/EthereumServiceTesting";
...
// @ts-ignore
Cypress.registerApplicationForTesting = function (aurelia: any) {
  console.log("TCL ~ file: wallet.e2e.ts ~ line 13 ~ registerApplicationForTesting");
